...
React/TypeScript rewrite of the VinylVault UI — **the default frontend**, served at `/`. The original vanilla HTML/CSS/JS frontend (`music_vault/static/music_vault/`, `music_vault/templates/music_vault/vinylvault.html`) is kept for reference/rollback at `/legacy/`. See [../docs/frontend.md#react-rewrite](../docs/frontend.md#react-rewrite) for the full picture: why this exists and how it's built into the Django package.
