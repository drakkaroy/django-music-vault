...
Deep-reference docs for django-music-vault. Start with the repo [README](../README.md) for a quick overview and quickstart — come here for detail.

- [setup.md](setup.md) — local dev environment, running tests, common errors
- [integration.md](integration.md) — step-by-step checklist to add `music_vault` to an existing Django project
- [architecture.md](architecture.md) — package/project split, decoupling rules, data flow, models
